...
Spring注解驱动开发（一）
https://www.jianshu.com/p/89227de5befe
Spring注解驱动开发（二）
https://www.jianshu.com/p/874c7a53bc6e
Spring注解驱动开发（三）
https://www.jianshu.com/p/74bded1b2836


Spring注解驱动开发（一）
https://blog.csdn.net/weixin_37778801/article/details/86233124
Spring注解驱动开发（二）
https://blog.csdn.net/weixin_37778801/article/details/86286817
Spring注解驱动开发（三）
https://blog.csdn.net/weixin_37778801/article/details/86484638
Spring注解驱动开发（四）
https://blog.csdn.net/weixin_37778801/article/details/86497844
Spring注解驱动开发（五）
https://blog.csdn.net/weixin_37778801/article/details/86512928
Spring注解驱动开发（六）
https://blog.csdn.net/weixin_37778801/article/details/86522477
```
...
**需要说明的是调用在@Configuration中调用@Bean注解的方法时，会做特殊处理，我们不必担心这个单例的bean被创建多次，spring会做判断，这个bean只会实例化一次。**
...
配置类，只扫描Controller，必须配置useDefaultFilters为false
```java
@Configuration
//@ComponentScan("com")
...
public class MainConfig {
    ...
    //给容器中注册一个Bean;类型为返回值的类型，id默认是用方法名作为id，可以通过value属性指定
    @Bean("person01")
    public Person person(){
        return new Person("莫南", 18);
    }
}
```
